...
# snr_means.m 
This script computes SNR similarly to snr_new.m, but instead of a linear regression simply takes the differnece between the ensemble mean at time t and the ensemble mean at time t+1 to get the noise component. This method is not as effective but was used as a possible alternative. 
